...
"""Verify that starting uno with -h works as expected."""
import subprocess

from test_framework.test_framework import UnoTestFramework
from test_framework.util import assert_equal

class HelpTest(UnoTestFramework):
    ...
    def run_test(self):
        self.log.info("Start uno with -? for help text")
        ...
        self.log.info("Start uno with -version for version information")
