#!/usr/bin/env python3
# Copyright (c) 2020 The UNO Core developers
...
class SaplingMempoolTest(UnoTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 UNO note to Alice
        ...
        # miner sends another 10 UNO note to Alice
