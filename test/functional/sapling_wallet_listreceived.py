...
class ListReceivedTest (UnoTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 UNO.
        ...
        # Send 1 UNO to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 UNO sending them all (fee is 0.1 UNO)
        ...
        # Confirm transaction (2 UNO from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 UNO, send 0.6 UNO + 0.05 UNO fee
