...
from test_framework.test_framework import UnoTier2TestFramework
...
class MasternodeGovernanceBasicTest(UnoTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.uno.cm/t/test-proposal"
