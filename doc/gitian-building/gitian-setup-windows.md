...
The build script we'll be using is contained in the UNO github repository ([contrib/gitian-build.py](https://github.com/uno-cm/UNO/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the UNO repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/UNO-Project/UNO/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, uno-detached-sigs, and uno GitHub repos.
