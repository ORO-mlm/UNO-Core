...
The script [extract-osx-sdk.sh](https://github.com/uno-cm/UNO/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
uno/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/uno-cm/UNO/blob/master/doc/README_osx.md) for troubleshooting tips.