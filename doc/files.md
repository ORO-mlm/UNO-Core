...
uno.conf           | contains configuration settings for unod or uno-qt
unod.pid           | stores the process id of unod while running
...
debug.log           | contains debug information and general logging generated by unod or uno-qt
