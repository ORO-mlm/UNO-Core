...
This issue tracker is only for technical issues related to UNO Core.
General UNO questions and/or support requests and are best directed to the [UNO Discord](https://discord.uno.cm).
...
### What version of UNO Core are you using?
