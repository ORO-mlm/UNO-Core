...
RESOURCES += src/qt/uno.qrc src/qt/uno_locale.qrc

TRANSLATIONS += src/qt/locale/uno_bg.ts \
                src/qt/locale/uno_de.ts \
                src/qt/locale/uno_en.ts \
                src/qt/locale/uno_es.ts \
                src/qt/locale/uno_fi.ts \
                src/qt/locale/uno_fr.ts \
                src/qt/locale/uno_it.ts \
                src/qt/locale/uno_ja.ts \
                src/qt/locale/uno_pl.ts \
                src/qt/locale/uno_pt.ts \
                src/qt/locale/uno_ru.ts \
                src/qt/locale/uno_sk.ts \
                src/qt/locale/uno_sv.ts \
                src/qt/locale/uno_vi.ts \
                src/qt/locale/uno_zh_CN.ts \
                src/qt/locale/uno_zh_TW.ts
