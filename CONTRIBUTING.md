Contributing to UNO Core
============================

The UNO Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/uno-cm/UNO/blob/master/doc/translation_process.md)
...
The following applies to code changes to the UNO Core project, and is not to be
confused with overall UNO Network Protocol consensus changes.

Whether a pull request is merged into UNO Core rests with the project merge
...
Patches that change UNO consensus rules are considerably more involved than
...
Where a patchset proposes to change the UNO consensus, it must have been
...
The project leader is the release manager for each UNO Core release.
