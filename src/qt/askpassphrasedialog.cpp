...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            UNOGUI* window = static_cast<UNOGUI*>(parentWidget());
...
{
    UNOGUI* gui = static_cast<UNOGUI*>(parentWidget());
...
{
    hide();
    static_cast<UNOGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("UNO will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your UNOs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
