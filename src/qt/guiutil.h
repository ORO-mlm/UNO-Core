...
/** Utility functions used by the UNO Qt UI.
 */
namespace GUIUtil
{
...
// Render UNO addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZuno = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZuno = false);
...
// Parse "uno:" URI into recipient object, return true on successful parsing
