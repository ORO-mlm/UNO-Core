...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(UNO);
    unitlist.append(mUNO);
    unitlist.append(uUNO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case mUNO:
        return QString("muno");
    case uUNO:
        return QString::fromUtf8("uuno");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZuno)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZUNO)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZUNO);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZUNO)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZUNO));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
