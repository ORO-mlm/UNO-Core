...
#include "qt/uno/topbar.h"
#include "qt/uno/forms/ui_topbar.h"
#include "qt/uno/lockunlock.h"
#include "qt/uno/qtutils.h"
#include "qt/uno/receivedialog.h"
#include "qt/uno/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/uno/balancebubble.h"
...
TopBar::TopBar(UNOGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopUno}, "amount-small-topbar");
    setCssProperty({ui->labelAmountUno}, "amount-topbar");
    setCssProperty({ui->labelPendingUno, ui->labelImmatureUno}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // UNO Total
    QString totalUno = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // UNO
    // Top
    ui->labelAmountTopUno->setText(totalTransparent);
    // ui->labelAmountTopShieldedUno->setText(totalShielded);
    // Expanded
    ui->labelAmountUno->setText(totalUno);
    ui->labelPendingUno->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureUno->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
