...
#include "qt/uno/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(UNOGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    btns = {ui->btnDashboard, ui->btnSend, ui->btnReceive, ui->btnAddress, ui->btnColdStaking, ui->btnSettings, ui->btnColdStaking};
