...
#ifndef UNO_CORE_NEW_GUI_UNOGUI_H
#define UNO_CORE_NEW_GUI_UNOGUI_H
...
#include "qt/uno/navmenuwidget.h"
#include "qt/uno/topbar.h"
#include "qt/uno/dashboardwidget.h"
#include "qt/uno/send.h"
#include "qt/uno/receivewidget.h"
#include "qt/uno/addresseswidget.h"
#include "qt/uno/coldstakingwidget.h"
#include "qt/uno/masternodeswidget.h"
#include "qt/uno/snackbar.h"
#include "qt/uno/settings/settingswidget.h"
#include "qt/uno/settings/settingsfaqwidget.h"
...
/**
  UNO GUI main class. This class represents the main window of the UNO UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class UNOGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit UNOGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~UNOGUI();
...
#endif //UNO_CORE_NEW_GUI_UNOGUI_H
