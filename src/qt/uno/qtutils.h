...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, UNOGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, UNOGUI* gui, double posX = 3);
