...
#include "qt/uno/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/uno/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("42005");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("42003");
    } else {
        ui->lineEditPort->setText("42001");
    }
