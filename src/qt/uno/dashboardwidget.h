...
#include "config/uno-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalUno = 0;
    qint64 totalZuno = 0;
    QList<qreal> valuesUno;
    QList<qreal> valueszUno;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(UNOGUI* _window);
    ~DashboardWidget();
