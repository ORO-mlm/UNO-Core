...
#include "qt/uno/sendcustomfeedialog.h"
#include "qt/uno/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(UNOGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &UNOGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
