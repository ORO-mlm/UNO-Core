...
#include "qt/uno/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(UNOGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("UNO_tx_csv_export(*.csv)") : tr("UNO_addresses_csv_export(*.csv)"),
                                        nullptr);
