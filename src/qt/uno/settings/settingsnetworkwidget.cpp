...
#include "qt/uno/settings/settingsnetworkwidget.h"
#include "qt/uno/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/uno/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(UNOGUI* _window, QWidget *parent) :
