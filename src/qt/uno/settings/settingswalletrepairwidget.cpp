...
#include "qt/uno/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/uno/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(UNOGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to UNOGUI::handleRestart()
