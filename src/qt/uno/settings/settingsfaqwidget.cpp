...
#include "qt/uno/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/uno/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(UNOGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableUNO,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableUNO,
    ...
    connect(ui->pushButton_UnspendableUNO, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableUNO);});
    ...
    if (parent)
        connect(parent, &UNOGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
