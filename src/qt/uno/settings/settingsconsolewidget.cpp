...
#include "qt/uno/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/uno/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(UNOGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the UNO RPC console.") + "<br>" +
