...
#include <QWidget>
#include "qt/uno/pwidget.h"
#include "qt/uno/settings/settingsbackupwallet.h"
#include "qt/uno/settings/settingsexportcsv.h"
#include "qt/uno/settings/settingsbittoolwidget.h"
#include "qt/uno/settings/settingssignmessagewidgets.h"
#include "qt/uno/settings/settingswalletrepairwidget.h"
#include "qt/uno/settings/settingswalletoptionswidget.h"
#include "qt/uno/settings/settingsmainoptionswidget.h"
#include "qt/uno/settings/settingsdisplayoptionswidget.h"
#include "qt/uno/settings/settingsmultisendwidget.h"
#include "qt/uno/settings/settingsinformationwidget.h"
#include "qt/uno/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(UNOGUI* parent);
    ~SettingsWidget();
