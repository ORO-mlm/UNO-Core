...
/* Uno GUI -- Size of icons in status bar */
...
#define COLOR_UNCONFIRMED QColor("#0470b5")
...
/* Transaction list -- TX status decoration - stake (BlueViolet #e2922b) */
#define COLOR_STAKE QColor("#7fccfd")
...
#define QAPP_ORG_NAME "UNO"
#define QAPP_ORG_DOMAIN "uno.cm"
#define QAPP_APP_NAME_DEFAULT "UNO-Qt"
#define QAPP_APP_NAME_TESTNET "UNO-Qt-testnet"
