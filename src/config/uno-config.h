/* src/config/uno-config.h.  Generated from uno-config.h.in by configure.  */
/* src/config/uno-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/uno-cm/UNO/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "UNO Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "UNO Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "uno"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://uno.cm/"
