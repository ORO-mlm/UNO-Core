...
extern const char * const UNO_CONF_FILENAME;
extern const char * const UNO_PID_FILENAME;
extern const char * const UNO_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("uno-%s", name);
